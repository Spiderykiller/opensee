...
import { idlFactory } from './openlook_frontend.did.js';
export { idlFactory } from './openlook_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OPENLOOK_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./openlook_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the openlook_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./openlook_frontend.did.js")._SERVICE>}
 */
export const openlook_frontend = createActor(canisterId);
