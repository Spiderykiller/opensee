...
import { idlFactory } from './openlook_backend.did.js';
export { idlFactory } from './openlook_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OPENLOOK_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./openlook_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the openlook_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./openlook_backend.did.js")._SERVICE>}
 */
export const openlook_backend = createActor(canisterId);
